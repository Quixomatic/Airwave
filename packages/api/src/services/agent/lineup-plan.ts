...
- Group syntax: \`{type:"group", combinator:"and"|"or", children:[…]}\`. Conditions use \`op\` (is / isNot / contains / notContains / equals / notEquals / beginsWith / endsWith / gte / lte; on text fields contains=substring, equals=exact); groups use \`combinator\`. One level of nesting is allowed inside a top-level group.
