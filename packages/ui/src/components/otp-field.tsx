...
// From the coss registry (@coss/otp-field, base-lyra), built on Base UI's OTPField primitive. Only the two
// imports are adapted to our workspace aliases (cn + the existing Separator — NOT the coss one). The
// `--animate-caret-blink` keyframe it relies on already lives in globals.css.
