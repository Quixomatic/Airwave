  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          // `h-dvh` (dynamic viewport height) — tracks the actual visible
          // viewport. On desktop browsers with no dynamic chrome it
          // resolves identically to `h-svh` / `h-lvh` / `100vh`.
          // In CEF/Electrobun, viewport units come up stale on first
          // paint; `main.tsx` dispatches a synthetic resize on mount to
          // force a recompute.
          "group/sidebar-wrapper bg-noisy flex h-dvh w-full",
          className
        )}
        {...props}
      >
