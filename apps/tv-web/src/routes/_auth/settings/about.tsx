...
/**
 * /settings/about — app identity + version, and nothing else. The server/connection rows that used
 * to live here moved to their own /settings/server page. This page has no focusable rows;
 * `useSettingsPage(0)` keeps ◄/Back wired to the category rail.
 */
  ...
  return (
    <div>
      ...
      <p style={{ marginTop: 20, fontSize: 15, color: "#64748b", maxWidth: 640 }}>
        Looking for the connected server, the Plex connection, or how to sign out? Those live under <strong style={{ color: "#94a3b8" }}>Server</strong> and{" "}
