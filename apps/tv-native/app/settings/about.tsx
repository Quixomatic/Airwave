...
export default function About() {
  ...
  return (
    <View>
      ...
      <View style={{ gap: 10, padding: 34, borderRadius: 18, backgroundColor: "rgba(148,163,184,0.06)", maxWidth: 640 }}>
        <Text style={{ fontSize: 52, fontWeight: "900", letterSpacing: -1, color: "#f1f5f9" }}>{APP_NAME}</Text>
        <Text style={{ fontSize: 19, color: "#94a3b8" }}>Your media server, as live TV.</Text>
        <View style={{ marginTop: 12, alignSelf: "flex-start", backgroundColor: "rgba(74,159,224,0.16)", borderRadius: 999, paddingVertical: 6, paddingHorizontal: 14 }}>
          <Text style={{ fontSize: 14, fontWeight: "700", letterSpacing: 0.5, color: "#4a9fe0" }}>Version {APP_VERSION}</Text>
        </View>
      </View>

      <Text style={{ marginTop: 24, fontSize: 16, lineHeight: 26, color: "#94a3b8", maxWidth: 640 }}>
