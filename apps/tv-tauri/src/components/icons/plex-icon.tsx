/** The Plex tile logo — a dark rounded tile (#282a2d) with the Plex-gold chevron (#e5a00d). The
 * official tile mark (vectorlogo.zone plextv-tile). Ported from apps/web `components/icons/plex-icon`. */
