...
> **Store status.** Airwave is live on **Apple TV** (App Store), **Fire TV** (Amazon Appstore), **Android TV /
> Google TV** (Google Play), and **Roku** (Roku Channel Store), with **iPad** in App Store review. **LG webOS**
> and **Samsung (Tizen)** run as packaged web apps that you sideload (build from source or install the packaged
> app directly). The **desktop app** ships on **Windows, macOS** (Apple Silicon + Intel), and **Linux**: Windows
