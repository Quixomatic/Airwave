---
icon: Activity
title: "Sessions (Now Playing)"
description: "The admin view of who's watching and how each stream is being delivered."
---
...
| Stale-session reaper job (`watch-session-reap`) | `packages/api/src/services/jobs/definitions.ts` · [docs/jobs.md](/docs/jobs) |
