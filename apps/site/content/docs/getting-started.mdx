...
- **Move a lineup between instances.** Export your packages + channels + filters and import them into another Airwave, with dry-run and de-duplication. See **[Import / Export →](/docs/import-export)**.
