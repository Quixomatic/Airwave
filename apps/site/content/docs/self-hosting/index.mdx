...
- **[One-click desktop app](/docs/self-hosting/desktop)** — for running Plex on your own Windows, macOS, or
  ...
  start.
- **Docker** — for a NAS, mini-PC, or always-on Linux box. A single prebuilt image plus a Postgres database,
  wired by `docker compose`. This section walks that path in detail below.
