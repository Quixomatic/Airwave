...
small and auditable — read them first at [getairwave.tv/install.sh](https://getairwave.tv/install.sh) or
[/install.ps1](https://getairwave.tv/install.ps1) if you prefer. Rather wire it up by hand? The manual
